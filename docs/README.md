...
- [controllers.md](controllers.md) — every routed controller (6 found): method signatures, Form Request validation rules, extracted response examples
- [routes.md](routes.md) — the full route table (42 routes), grouped by role
